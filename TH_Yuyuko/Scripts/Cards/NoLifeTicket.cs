...
public class NoLifeTicket : YuyukoCardModel
{
	...
	public NoLifeTicket() : base(1, CardType.Attack, CardRarity.Ancient, TargetType.AnyEnemy)
	{
	}
	...
	protected override async Task OnPlay(PlayerChoiceContext choiceContext, CardPlay cardPlay)
	{
		...
		.WithHitVfxNode(target => YuyukoVfxManager.CreateProjectileToTarget("AncientEffect", Owner.Creature, target, new Vector2(0f, -180f),  new Vector2(0f, -40f)))
		.Execute(choiceContext);
		if(cardPlay.Target!=null&&cardPlay.Target.IsAlive)
		await PowerCmd.Apply<DemisePower>(cardPlay.Target,attackCommand.Results.Sum((DamageResult r) => r.TotalDamage + r.OverkillDamage),Owner.Creature,this);
	}
