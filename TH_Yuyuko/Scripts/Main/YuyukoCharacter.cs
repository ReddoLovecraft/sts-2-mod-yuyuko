...
羽化药水 罕见
选择任意张手牌变化，变化后的卡牌在本回合内首次打出前耗能为0。
...
遗物：
黑莲花 稀有遗物
你每回合首次通过卡牌给予负面效果时，获得一点能量。
远古的经书上记载着，“法力池”的水面上总是有许多这些花朵。

御所车画屏 罕见遗物
带有死意的敌人对你造成的伤害减少其死意层数点。
根据幽幽子扇子的图案仿制的装饰用画屏，意外地含有一些强大的灵力。

石樱 罕见遗物
每当敌人死亡时，获得等同于其死意层数的金币。
怨灵的最爱，甚至因此掀起了「宁可不要自由也要石樱」的运动，虽然最后又再度变得温顺了。
